    ...
    class Merlin
    {
        ...
        function required_classes() {
            ...
            if ( !class_exists( 'Merlin_WXR_Parser' ) ) {
                require get_parent_theme_file_path( $this->directory . '/includes/class-merlin-xml-parser.php' );
            }

            if ( !class_exists( 'Merlin_Importer' ) ) {
                require get_parent_theme_file_path( $this->directory . '/includes/class-merlin-importer.php' );
        ...
        protected function child() {
            ...
            <div class="merlin__content--transition">
                ...
                <a class="merlin__button merlin__button--knockout merlin__button--no-chevron"
                ...
                <?php if ( !$is_child_theme ) : ?>
                    ...
                    <a href="<?php echo esc_url( $this->step_next_link() ); ?>"
                       class="merlin__button merlin__button--next button-next" data-callback="install_child">
                        <span
                            class="merlin__button--loading__text"><?php echo esc_html( $install ); ?></span><?php echo $this->loading_spinner(); ?>
                    </a>
                ...
                <ul class="merlin__drawer merlin__drawer--import-content">
                    <?php
                        foreach ( $content as $slug => $default ) :
                            ...
                            <li class="merlin__drawer--import-content__list-item status status--<?php echo esc_attr( $default[ 'pending' ] ); ?>"
                                data-content="<?php echo esc_attr( $slug ); ?>">
                                <input type="checkbox" name="default_content[<?php echo esc_attr( $slug ); ?>]"
                                       class="checkbox" id="default_content_<?php echo esc_attr( $slug ); ?>"
                ...
                <footer class="merlin__content__footer">
                    ...
                    <a href="<?php echo esc_url( $this->step_next_link() ); ?>"
                       class="merlin__button merlin__button--next button-next" data-callback="install_content">
                        <span
                            class="merlin__button--loading__text"><?php echo esc_html( $import ); ?></span><?php echo $this->loading_spinner(); ?>
                    </a>
        ...
        protected function get_base_content() {
            ...
            if ( !empty( $content ) && is_array( $content ) ) {
                foreach ( $content as $slug => $data ) {
                    ...
                    $content[ $slug ][ 'description' ] = sprintf( esc_html__( 'Sample %s data.', 'merlin-wp' ), $slug );
                    $content[ $slug ][ 'pending' ] = esc_html__( 'Pending', 'merlin-wp' );
                    $content[ $slug ][ 'installing' ] = esc_html__( 'Installing', 'merlin-wp' );
                    $content[ $slug ][ 'success' ] = esc_html__( 'Success', 'merlin-wp' );
            ...
            if ( file_exists( $base_dir . 'slider.zip' ) ) {
                $content[ 'sliders' ] = array(
                    'title' => esc_html__( 'Sliders', 'merlin-wp' ),
                    'description' => esc_html__( 'Sample sliders data.', 'merlin-wp' ),
                    'pending' => esc_html__( 'Pending', 'merlin-wp' ),
                    'installing' => esc_html__( 'Installing', 'merlin-wp' ),
                    'success' => esc_html__( 'Success', 'merlin-wp' ),
